        ...
        try {
            ...
            frame.btnNewButton_1.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    String firstname = frame.textField.getText();
                    String lastname = frame.textField_1.getText();
                    String email = frame.textField_2.getText();
                    String telephone = frame.textField_3.getText();
